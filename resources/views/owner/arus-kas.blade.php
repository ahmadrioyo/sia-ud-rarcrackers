                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="mt-3">
                                        <a href="{{ route('owner.arus-kas', ['export' => 'pdf']) }}" class="btn btn-outline-secondary align-self-center" id="print-link">
        ...
        $('#reservation').on('apply.daterangepicker', function(ev, picker) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#print-link').attr('href', '{{ route("owner.arus-kas") }}' + '?export=pdf&start_date=' + startDate + '&end_date=' + endDate);
                },
